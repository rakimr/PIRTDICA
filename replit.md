...
-   **Prop Trend Analysis Modal:** Visualizes a player's last 10 games for a specific stat against book lines, providing OVER/UNDER calls. Prop recommendations now blend DVP and DVA edges using season-progress-weighted blend (70/30 DVP-heavy early season to 30/70 DVA-heavy late season), with per-stat archetype-level matchup adjustments for more precise OVER/UNDER signals.
