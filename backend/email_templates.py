...
def trial_started_email(username: str, plan_name: str, access_description: str,
                        trial_end_str: str, price_str: str) -> tuple[str, str]:
    subject = f"Your {plan_name} free trial has started"
    content = f"""
